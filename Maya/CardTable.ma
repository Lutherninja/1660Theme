...
//Name: CardTable.ma
//Last modified: Thu, Apr 26, 2018 02:01:39 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.061824081145296 4.8798673460821362 -9.7548279081340681 ;
	setAttr ".r" -type "double3" 2.0616472721971086 -3105.8000000009897 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "8215A31E-4A7E-5079-3899-DC8782ADDA34";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 15.003619446386526;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.28846552848404711 5.1611589877115858 1.689446712048754 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
	setAttr ".ai_translator" -type "string" "perspective";
createNode transform -s -n "top";
	rename -uid "95725DEE-4F71-BEF0-C10F-1092DB9F8EAC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.28846552848404716 1000.1203462492143 1.6894467120489749 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "DDE1EBA6-4A19-A97B-2C8B-1BB6E0680084";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 994.95918726150273;
	setAttr ".ow" 2.3323326380275367;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.28846552848404716 5.1611589877115858 1000.1572411648586 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "FD40D550-4AFA-62FB-9E60-0987B9CA1428";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 998.46779445280993;
	setAttr ".ow" 1.157258366154345;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.143193470695 5.1611589877115858 1.689446712048976 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "0AA727ED-40CF-F4ED-CA79-BFB07D7D3496";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 999.85472794221096;
	setAttr ".ow" 1.1787962791474909;
...
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.2411157600581646 0.53879931569099426 ;
	...
	setAttr -s 93 ".pt";
	setAttr ".pt[422]" -type "float3" 0.030325307 0.085002922 0.022032632 ;
	setAttr ".pt[423]" -type "float3" 0.025081798 0.085002922 0.027856158 ;
	setAttr ".pt[424]" -type "float3" 0.018742077 0.085002922 0.032462228 ;
	setAttr ".pt[425]" -type "float3" 0.011583245 0.085002922 0.035649553 ;
	setAttr ".pt[426]" -type "float3" 0.0039181663 0.085002922 0.037278816 ;
	setAttr ".pt[427]" -type "float3" -0.0039181518 0.085002922 0.037278816 ;
	setAttr ".pt[428]" -type "float3" -0.01158323 0.085002922 0.035649553 ;
	setAttr ".pt[429]" -type "float3" -0.018742071 0.085002922 0.032462232 ;
	setAttr ".pt[430]" -type "float3" -0.02508178 0.085002922 0.02785616 ;
	setAttr ".pt[431]" -type "float3" -0.030325301 0.085002922 0.022032635 ;
	setAttr ".pt[432]" -type "float3" -0.034243464 0.085002922 0.015246184 ;
	setAttr ".pt[433]" -type "float3" -0.036665026 0.085002922 0.0077933995 ;
	setAttr ".pt[434]" -type "float3" -0.037484147 0.085002922 6.1518941e-09 ;
	setAttr ".pt[435]" -type "float3" -0.03666503 0.085002922 -0.0077933869 ;
	setAttr ".pt[436]" -type "float3" -0.034243464 0.085002922 -0.015246178 ;
	setAttr ".pt[437]" -type "float3" -0.030325301 0.085002922 -0.022032622 ;
	setAttr ".pt[438]" -type "float3" -0.02508178 0.085002922 -0.027856154 ;
	setAttr ".pt[439]" -type "float3" -0.018742071 0.085002922 -0.032462224 ;
	setAttr ".pt[440]" -type "float3" -0.01158323 0.085002922 -0.035649557 ;
	setAttr ".pt[441]" -type "float3" -0.0039181467 0.085002922 -0.037278816 ;
	setAttr ".pt[442]" -type "float3" 0.0039181774 0.085002922 -0.037278816 ;
	setAttr ".pt[443]" -type "float3" 0.011583259 0.085002922 -0.035649557 ;
	setAttr ".pt[444]" -type "float3" 0.018742098 0.085002922 -0.032462224 ;
	setAttr ".pt[445]" -type "float3" 0.025081811 0.085002922 -0.027856154 ;
	setAttr ".pt[446]" -type "float3" 0.030325342 0.085002922 -0.022032622 ;
	setAttr ".pt[447]" -type "float3" 0.034243513 0.085002922 -0.015246167 ;
	setAttr ".pt[448]" -type "float3" 0.036665067 0.085002922 -0.0077933776 ;
	setAttr ".pt[449]" -type "float3" 0.037484147 0.085002922 1.025316e-08 ;
	setAttr ".pt[450]" -type "float3" 0.036665026 0.085002922 0.0077933995 ;
	setAttr ".pt[451]" -type "float3" 0.034243464 0.085002922 0.015246183 ;
	setAttr ".pt[452]" -type "float3" -0.015204457 0 -0.011046689 ;
	setAttr ".pt[453]" -type "float3" -0.01257547 0 -0.013966483 ;
	setAttr ".pt[454]" -type "float3" -0.0093968743 0 -0.016275864 ;
	setAttr ".pt[455]" -type "float3" -0.0058075883 0 -0.017873917 ;
	setAttr ".pt[456]" -type "float3" -0.0019644832 0 -0.018690797 ;
	setAttr ".pt[457]" -type "float3" 0.0019644783 0 -0.018690797 ;
	setAttr ".pt[458]" -type "float3" 0.0058075842 0 -0.017873917 ;
	setAttr ".pt[459]" -type "float3" 0.0093968725 0 -0.016275866 ;
	setAttr ".pt[460]" -type "float3" 0.01257547 0 -0.013966485 ;
	setAttr ".pt[461]" -type "float3" 0.015204458 0 -0.011046692 ;
	setAttr ".pt[462]" -type "float3" 0.017168935 0 -0.0076441094 ;
	setAttr ".pt[463]" -type "float3" 0.018383056 0 -0.0039074454 ;
	setAttr ".pt[464]" -type "float3" 0.018793745 0 -4.3650612e-09 ;
	setAttr ".pt[465]" -type "float3" 0.018383062 0 0.0039074346 ;
	setAttr ".pt[466]" -type "float3" 0.017168935 0 0.007644102 ;
	setAttr ".pt[467]" -type "float3" 0.015204458 0 0.011046682 ;
	setAttr ".pt[468]" -type "float3" 0.01257547 0 0.013966475 ;
	setAttr ".pt[469]" -type "float3" 0.0093968725 0 0.01627586 ;
	setAttr ".pt[470]" -type "float3" 0.0058075842 0 0.017873917 ;
	setAttr ".pt[471]" -type "float3" 0.0019644755 0 0.018690797 ;
	setAttr ".pt[472]" -type "float3" -0.001964489 0 0.018690797 ;
	setAttr ".pt[473]" -type "float3" -0.0058075939 0 0.017873917 ;
	setAttr ".pt[474]" -type "float3" -0.0093968837 0 0.01627586 ;
	setAttr ".pt[475]" -type "float3" -0.01257548 0 0.013966475 ;
	setAttr ".pt[476]" -type "float3" -0.015204477 0 0.011046682 ;
	setAttr ".pt[477]" -type "float3" -0.01716896 0 0.007644102 ;
	setAttr ".pt[478]" -type "float3" -0.018383065 0 0.0039074318 ;
	setAttr ".pt[479]" -type "float3" -0.018793745 0 -6.8593815e-09 ;
	setAttr ".pt[480]" -type "float3" -0.018383056 0 -0.0039074454 ;
	setAttr ".pt[481]" -type "float3" -0.017168935 0 -0.0076441085 ;
	setAttr ".pt[482]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[483]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[484]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[485]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[486]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[487]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[488]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[489]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[490]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[491]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[492]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[493]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[494]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[495]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[496]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[497]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[498]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[499]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[500]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[501]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[502]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[503]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[504]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[505]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[506]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[507]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[508]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[509]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[510]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[511]" -type "float3" 0 -0.085002914 0 ;
	setAttr ".pt[593]" -type "float3" -7.4505806e-09 0 0 ;
	setAttr ".pt[594]" -type "float3" -1.8626451e-09 0 0 ;
	setAttr ".pt[598]" -type "float3" 7.4505806e-09 0 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode transform -n "pCube13";
	rename -uid "7741A679-41EF-92D7-2DA8-7F8042FD5070";
	setAttr ".t" -type "double3" 0.28846552848404716 5.8671278597716467 1.6894467120487542 ;
...
createNode transform -n "pCube14";
	rename -uid "E2142938-4C88-F147-07F2-8CB85F6F3A87";
	setAttr ".t" -type "double3" 0.28846552848404716 5.8781657170007016 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode transform -n "pCube15";
	rename -uid "ABD4C8E6-46D1-D066-341B-8C9CD38C765A";
	setAttr ".t" -type "double3" 0.35631987469037985 5.8880165774778908 1.7620074841518638 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape15" -p "pCube15";
	rename -uid "CDB9293F-4E94-2D5B-C6C6-398F0A276E48";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube16";
	rename -uid "84DCC97D-4CF1-CB2A-DE8B-91B68F326C4E";
	setAttr ".t" -type "double3" 0.28846552848404716 5.8978611740844507 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -41.457390085574069 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape16" -p "pCube16";
	rename -uid "93C505AE-4BB6-47E6-B3F8-8C828AD1001C";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube17";
	rename -uid "A2E44D6A-42C8-D8C6-8B88-7F80C6F25E48";
	setAttr ".t" -type "double3" 0.28846552848404716 5.907709567280385 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape17" -p "pCube17";
	rename -uid "1A6DD654-4A83-952B-36E9-618A8E35BE64";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube18";
	rename -uid "C66F9EFF-47F4-B2E4-5E2E-8BA0FF6AE54F";
	setAttr ".t" -type "double3" 0.28846552848404716 5.9208359465917937 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape18" -p "pCube18";
	rename -uid "E5D90B6A-47DC-7FFB-67D1-49B317D84153";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube19";
	rename -uid "13D2EF0F-4078-9FCC-5FA5-0499EDF3E69E";
	setAttr ".t" -type "double3" 0.28846552848404716 5.9308594514234532 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape19" -p "pCube19";
	rename -uid "5E82B1D2-423E-DADB-D84C-0BA018B2A2E6";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube20";
	rename -uid "D2E098D2-4233-78AA-8BC5-F2947C6546A0";
	setAttr ".t" -type "double3" 0.28846552848404716 5.9386099470245011 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape20" -p "pCube20";
	rename -uid "B71C5243-49D4-A51D-2A3A-7596774FACA9";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube21";
	rename -uid "0AF44F26-4270-422A-1499-76BAEBAA9FF5";
	setAttr ".t" -type "double3" 0.28846552848404716 5.949378803577603 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -42.809607886856654 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape21" -p "pCube21";
	rename -uid "7E5DF6DD-4E9E-F443-806A-60B4BBFB10E5";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube22";
	rename -uid "A4193A8A-4C16-EC5D-689C-469DA11AC37D";
	setAttr ".t" -type "double3" 0.25671198410892521 5.9604076556884369 1.6554907191656612 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape22" -p "pCube22";
	rename -uid "044D1AB8-45C0-ACF5-0373-DEAE9863BA16";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube23";
	rename -uid "6F74A4E9-4C17-2F68-9BBF-BFAC7D363A26";
	setAttr ".t" -type "double3" 0.28846552848404716 5.97 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape23" -p "pCube23";
	rename -uid "51B61D53-444A-F2D8-62D4-9D96BB7A813C";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube24";
	rename -uid "AAD7AB7A-4493-168F-C4B1-5FBE12742BE4";
	setAttr ".t" -type "double3" 0.28846552848404716 5.981 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape24" -p "pCube24";
	rename -uid "82ED6DE4-4EA6-05D4-6E25-5FB9D58178E0";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube25";
	rename -uid "F319B272-4DE4-A7C7-BEF3-0EB11C141683";
	setAttr ".t" -type "double3" 0.31080526124770036 5.992 1.7133359446261145 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape25" -p "pCube25";
	rename -uid "2BB8A509-4265-C312-FE42-1FB5E7C5CB2E";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube26";
	rename -uid "C774FF8E-4F6F-932A-9F05-0FA157E74F69";
	setAttr ".t" -type "double3" 0.28846552848404716 6.001 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape26" -p "pCube26";
	rename -uid "614C64E0-4D0D-C9A4-8CFE-0E84531EA4F2";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube27";
	rename -uid "8D743689-4E8D-339F-0E11-1996B60C1343";
	setAttr ".t" -type "double3" 0.28846552848404716 6.012 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -47.587407340226534 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape27" -p "pCube27";
	rename -uid "4F3BD373-4153-8558-3CAF-A0B0961F7F75";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
...
createNode transform -n "pCube28";
	rename -uid "691E0890-43ED-6051-48BE-099532A6E323";
	setAttr ".t" -type "double3" 0.28846552848404716 6.023 1.6894467120487542 ;
	setAttr ".r" -type "double3" 0 -63.884763306619845 0 ;
	setAttr ".s" -type "double3" 0.94567094358381931 0.009512399608806156 0.62517858973238238 ;
createNode mesh -n "pCubeShape28" -p "pCube28";
	rename -uid "EB101F1A-4533-1252-D83A-BF905AE1C484";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47451465210178867 0.4999999861465767 ;
	...
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
parent -s -nc -r -add "|pCube13|pCubeShape13" "pCube14" ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "93EA2E40-49F2-B538-641F-989FED06532C";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D1FDBF81-4A07-62DD-19CB-4CB266E0831E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "41DDDA4A-4290-43AE-A991-42A64C207F8C";
createNode displayLayerManager -n "layerManager";
	rename -uid "82553A62-4053-4EAA-63C2-32B544E32F9D";
createNode displayLayer -n "defaultLayer";
	rename -uid "B2874063-46C6-731E-EC50-E5ACE7F757B9";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0F443492-4FCD-EA1E-AF48-9D992140F94C";
...
createNode polyTweak -n "polyTweak16";
	...
	setAttr ".uopa" yes;
	setAttr ".tk[650]" -type "float3"  0.021347284 0.0038335323 -0.0073033571;
...
createNode polyTweak -n "polyTweak17";
	...
	setAttr ".uopa" yes;
	setAttr -s 3 ".tk[647:649]" -type "float3"  0.025730437 0 -0.025003396
		 0.0095917266 0 0 0.025730437 0 -0.025003396;
...
createNode polyBridgeEdge -n "polyBridgeEdge8";
	...
	setAttr ".sv2" 636;
	setAttr ".d" 1;
createNode lambert -n "Cards";
	rename -uid "55F7AD1A-4F57-070D-CE62-B1969CDC0AB9";
createNode shadingEngine -n "lambert2SG";
	rename -uid "AF50513B-4948-5E33-CDE4-94A9E538C17A";
	setAttr ".ihi" 0;
	setAttr -s 16 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "78CA88E7-4B13-1128-E196-50B31CD7FD5E";
createNode lambert -n "table";
	rename -uid "CED5FE24-4274-5FE7-45FC-E29A6956E870";
createNode shadingEngine -n "lambert3SG";
	rename -uid "51F37F3D-4596-E635-E883-969912E41E46";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "F3A2E52D-4072-9EC4-480B-C9AC0AADB36D";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "|pCube13|pCubeShape13.iog" "lambert2SG.dsm" -na;
connectAttr "lambert2SG.msg" "materialInfo1.sg";
connectAttr "Cards.msg" "materialInfo1.m";
...
connectAttr "Cards.msg" ":defaultShaderList1.s" -na;
